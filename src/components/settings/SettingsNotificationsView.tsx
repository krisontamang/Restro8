        ...
        <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
          <button
            ...
            style={{
              ...
              fontSize: '0.78rem',
              fontWeight: 600,
              border: `1px solid ${activeSectionFilter === 'all' ? '#EF4444' : 'var(--color-border)'}`,
              backgroundColor: activeSectionFilter === 'all' ? '#EF4444' : 'var(--color-card)',
            ...
            return (
              <button
                ...
                style={{
                  ...
                  fontSize: '0.78rem',
                  fontWeight: 600,
                  border: `1px solid ${isActive ? '#EF4444' : 'var(--color-border)'}`,
                  backgroundColor: isActive ? '#EF4444' : 'var(--color-card)',
